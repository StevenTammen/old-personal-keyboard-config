...
;----------------------------------------------------------------------
;
; Fetch info on all active windows (ORIGINAL SCRIPT VERSION: NO VIRTUAL DESKTOP SUPPORT)
;
;GetAllWindows()
;{
...
;----------------------------------------------------------------------
;
; Fetch info on all active windows (MODIFIED VERSION: VIRTUAL DESKTOP SUPPORT)
;
GetAllWindows()
{
  global switcher_id, filters
  ...
  Loop, %id%
  {
    ...
    ; don't add windows not in current virtual desktop (Added)
